srcdir = /home/software/php-8.0.7/ext/morse
builddir = /home/software/php-8.0.7/ext/morse
top_srcdir = /home/software/php-8.0.7/ext/morse
top_builddir = /home/software/php-8.0.7/ext/morse
EGREP = /usr/bin/grep -E
SED = /usr/bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/usr/local/php8/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/usr/local/php8/bin/php-config'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
AWK = gawk
shared_objects_morse = morse.lo
PHP_PECL_EXTENSION = morse
PHP_MODULES = $(phplibdir)/morse.la
PHP_ZEND_EX =
...
prefix = /usr/local/php8
phplibdir = /home/software/php-8.0.7/ext/morse/modules
phpincludedir = /usr/local/php8/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
PHP_EXECUTABLE = /usr/local/php8/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/php8/include/php -I/usr/local/php8/include/php/main -I/usr/local/php8/include/php/TSRM -I/usr/local/php8/include/php/Zend -I/usr/local/php8/include/php/ext -I/usr/local/php8/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
...
.NOEXPORT:
morse.lo: /home/software/php-8.0.7/ext/morse/morse.c
	$(LIBTOOL) --mode=compile $(CC) -I. -I/home/software/php-8.0.7/ext/morse $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)   -c /home/software/php-8.0.7/ext/morse/morse.c -o morse.lo 
$(phplibdir)/morse.la: ./morse.la
	$(LIBTOOL) --mode=install cp ./morse.la $(phplibdir)

./morse.la: $(shared_objects_morse) $(MORSE_SHARED_DEPENDENCIES)
	$(LIBTOOL) --mode=link $(CC) -shared $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS)  -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_morse) $(MORSE_SHARED_LIBADD)
